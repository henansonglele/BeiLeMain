...
public class HtmlRegexpUtil {
	...
	public static void loadHtmlData(DDWebView mWebView, String url, String data) {
     LogM.d("url","load webview url:"+url);
     if(!url.contains("clientVersionNo")){//webview 添加公共参数
         if(url.contains("?")){
             mWebView.loadUrl(url + RetrofitParams.getParams());
         }else{
             mWebView.loadUrl(url + "?"+ RetrofitParams.getParams());
         }
